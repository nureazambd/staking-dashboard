...
// import Account from '@polkadot/react-params/Param/Account';
...
// import ValidatorsSection from './ValidatorsSection/index.js';
...
function StakingApp ({ basePath, className = '' }: Props): React.ReactElement<Props> {
  ...
  // function onStatusChange(status: ActionStatus): void {
