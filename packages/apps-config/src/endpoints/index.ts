...
// import { argoChains } from './testingArgoChain.js';
import { argoRPC_Scanner } from './argoChainRPC_Scanner.js';
...
export function createWsEndpoints (t: TFunction = defaultT, firstOnly = false, withSort = true): LinkOption[] {
  return [
    ...
    //   isHeader: true,
    //   isSpaced: true,
    //   text: t('rpc.header.dev', 'DevolvedAI', { ns: 'apps-config' }),
    //   textBy: '',
    //   ui: {},
    //   value: ''
    // },
    // ...expandEndpoints(t, argoChains, firstOnly, withSort),
...
// rpc Scanner
    {
      ...
      isHeader: true,
      isSpaced: true,
      text: t('rpc.header.dev', 'Argochain', { ns: 'apps-config' }),
      textBy: '',
      ui: {},
      value: ''
    },
    ...expandEndpoints(t, argoRPC_Scanner, firstOnly, withSort),
